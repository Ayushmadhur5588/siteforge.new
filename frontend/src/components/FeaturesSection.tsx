  ...
  const features = [
    {
      ...
      description:
        'Describe your website in natural language and watch as Siteforge generates all the code and assets for you.',
    },
    {
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-2xl sm:text-3xl text-center text-white font-medium">
          Why Choose Siteforge for Creating Website?
        </h2>
        <p className="text-lg text-center mt-4 max-w-lg mx-auto text-gray-400">
        Siteforge offers a powerful suite of features to make web development and
        ...
        <div className="text-center text-lg text-gray-400  mt-4">
          <h3>Siteforge is a powerful tool that combines the best of AI and web</h3>
        </div>
